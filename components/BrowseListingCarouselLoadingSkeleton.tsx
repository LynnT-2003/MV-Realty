...
const BrowseListingCarouselLoadingSkeleton: React.FC = () => {
  return (
        ...
        {[...Array(3)].map((_, index) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-2">
              <Skeleton className="w-[250px] h-[25px]" /> {/* Title */}
              <Skeleton className="w-[70px] h-[25px]" /> {/* Price */}
            </div>
            {/* Property details like Bed, Size, Bath, Floor */}
            <div className="flex pt-2 space-x-4">
              <Skeleton className="w-[40px] h-[25px]" /> {/* Bed */}
              <Skeleton className="w-[40px] h-[25px]" /> {/* Size */}
              <Skeleton className="w-[40px] h-[25px]" /> {/* Bath */}
              <Skeleton className="w-[40px] h-[25px]" /> {/* Floor */}
            </div>
          </div>
        ))}
      </div>
...
export default BrowseListingCarouselLoadingSkeleton;
