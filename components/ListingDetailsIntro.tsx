  ...
  return (
    <div className="w-full flex justify-center pb-16 md:pb-20">
      ...
      <div className="md:max-w-[1150px] w-[85vw] ipad-screen:hidden">
        <p className="poppins-text-title-small md:property-details-title-text lg:mb-0 mb-8">
          {listingDetails.listingName}
        </p>
        <Grid
          container
        ...
        >
          ...
          <Grid item xs={6}>
            <div className="flex">
              <img src="/icons/compass.svg" />
              <p className="ml-3.5">Facing {listingDetails.facingDirection}</p>
            </div>
          </Grid>
          <Grid item xs={6}>
            <div className="flex">
        ...
        <div className="flex w-full mb-2 mt-2 mb-6 justify-start">
          <p className="pt-1 text-red-400">
            Minimum Contract Period of {listingDetails.minimumContractInMonth}{" "}
            Months
          </p>
        </div>
