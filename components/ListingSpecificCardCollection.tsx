...
interface ListingSpecificCardCollectionProps {
  listings: Listing[];
  properties: Property[];
  showFilter: boolean;
...
const ListingSpecificCardCollection: React.FC<
  ListingSpecificCardCollectionProps
> = ({ listings, properties, showFilter, showProperties }) => {
...
export default ListingSpecificCardCollection;
