    ...
    <div className="w-full flex justify-center pb-12 md:pb-20">
      <div className="md:max-w-[1150px] w-[85vw]">
        <Grid container columnSpacing={10}>
          ...
          <Grid item md={5}>
            // Grid of information about the property
            <Grid
              container
            ...
            // Buttons to share the property and contact us
            ...
            // Button to view listings for this property
            <div className="mt-4">
              <button
                className="py-2 bg-[#193158] text-white font-semibold rounded-lg w-full text-xs"
                onClick={() => {
                  // Encode the listings as a JSON string
                  const listingsParam = encodeURIComponent(
                    JSON.stringify(listings)
                  );

                  // Navigate to the listings page and pass the listings as a parameter
